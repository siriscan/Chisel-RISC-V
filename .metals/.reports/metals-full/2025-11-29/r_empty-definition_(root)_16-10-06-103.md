error id: file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/DecodeStage.scala:integer/ControlSignals#aluSrc.
file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/DecodeStage.scala
empty definition using pc, found symbol in pc: integer/ControlSignals#aluSrc.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/io/controlSignals/aluSrc.
	 -chisel3/io/controlSignals/aluSrc#
	 -chisel3/io/controlSignals/aluSrc().
	 -chisel3/util/io/controlSignals/aluSrc.
	 -chisel3/util/io/controlSignals/aluSrc#
	 -chisel3/util/io/controlSignals/aluSrc().
	 -io/controlSignals/aluSrc.
	 -io/controlSignals/aluSrc#
	 -io/controlSignals/aluSrc().
	 -scala/Predef.io.controlSignals.aluSrc.
	 -scala/Predef.io.controlSignals.aluSrc#
	 -scala/Predef.io.controlSignals.aluSrc().
offset: 2716
...
class DecodeStage(conf: CoreConfig) extends Module {
    ...
    switch(opcode) {
      is("b0010011".U) { // I-type ALU Instructions
        ...
        switch(funct3) {
          is("b000".U) { io.controlSignals.aluOp := "b0000".U } // ADDI
          is("b111".U) { io.controlSignals.aluOp := "b0001".U } // ANDI
          is("b110".U) { io.controlSignals.aluOp := "b0010".U } // ORI
        }
      }
      is("b0000011".U) { // Load Instructions (e.g., LW)
        ...
        io.controlSignals.regWrite := true.B // Write to register
        io.controlSignals.aluOp := "b0000".U // ADD for address calculation
        io.immediate := imm_sext // Sign-extended immediate
      }
      is("b0100011".U) { // Store Instructions (e.g., SW)
        ...
        io.controlSignals.imm_fl@@ag  := true.B // Use immediate
      ...
      is("b1100011".U) { // Branch Instructions (e.g., BEQ)
        ...
        io.controlSignals.aluOp := "b0011".U // SUB for comparison
