error id: file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/DecodeStage.scala:local8
...
non-local guesses:
	 ...
	 -chisel3/io/imm_flag#
	 -chisel3/io/imm_flag().
	 -chisel3/util/io/imm_flag.
	 -chisel3/util/io/imm_flag#
	 -chisel3/util/io/imm_flag().
	 -io/imm_flag.
	 -io/imm_flag#
	 -io/imm_flag().
	 -scala/Predef.io.imm_flag.
	 -scala/Predef.io.imm_flag#
	 -scala/Predef.io.imm_flag().
offset: 2450
...
class DecodeStage(conf: CoreConfig) extends Module {
    ...
    switch(opcode) {
      ...
      is("b0100011".U) { // Store Instructions (e.g., SW)
        ...
        io.controlSignals.aluSrc := true.B // Use immediate
