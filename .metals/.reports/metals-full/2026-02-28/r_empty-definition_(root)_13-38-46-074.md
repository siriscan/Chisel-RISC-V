...
non-local guesses:
	 -chisel3/memory/io/stall.
	 -chisel3/memory/io/stall#
	 -chisel3/memory/io/stall().
	 -chisel3/util/memory/io/stall.
	 -chisel3/util/memory/io/stall#
	 -chisel3/util/memory/io/stall().
	 -core/memory/io/stall.
	 -core/memory/io/stall#
	 -core/memory/io/stall().
	 -memory/io/stall.
	 -memory/io/stall#
	 -memory/io/stall().
	 -scala/Predef.memory.io.stall.
	 -scala/Predef.memory.io.stall#
	 -scala/Predef.memory.io.stall().
offset: 6462
...
class RiscVPipeline extends Module {
  ...
  val pipeline_stall = hazard.io.stall || memory.io.s@@tall // If hazard unit or atomic unit detects a stall, we need to stall the fetch stage (hold PC)
