error id: file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala:wbEnable
file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala
empty definition using pc, found symbol in pc: wbEnable
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/writeback/io/wbEnable.
	 -chisel3/writeback/io/wbEnable#
	 -chisel3/writeback/io/wbEnable().
	 -chisel3/util/writeback/io/wbEnable.
	 -chisel3/util/writeback/io/wbEnable#
	 -chisel3/util/writeback/io/wbEnable().
	 -writeback/io/wbEnable.
	 -writeback/io/wbEnable#
	 -writeback/io/wbEnable().
	 -scala/Predef.writeback.io.wbEnable.
	 -scala/Predef.writeback.io.wbEnable#
	 -scala/Predef.writeback.io.wbEnable().
offset: 3199
...
class RiscVPipeline extends Module {
  ...
  // --- DECODE STAGE ---
  decode.io.C     := if_id.inst
  decode.io.pc       := if_id.pc
  decode.io.writeAddress := writeback.io.wbAddr
  decode.io.A     := writeback.io.wbData
  decode.io.writeEnable := writeback.io.wbE@@nable
