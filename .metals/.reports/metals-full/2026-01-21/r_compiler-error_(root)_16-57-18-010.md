...
### scala.ScalaReflectionException: value takeBranchDelayed is not a method
...
class RiscVPipeline extends Module {
  ...
  val takeBranchDelayed = RegNext(execute.io.branchTaken, false.B) /
  val branchTargetDelayed = RegNext(execute.io.branchTarget, 0.U)
