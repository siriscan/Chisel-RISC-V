error id: file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala:local0
...
non-local guesses:
	 -chisel3/fetch/io/takeBranch.
	 -chisel3/fetch/io/takeBranch#
	 -chisel3/fetch/io/takeBranch().
	 -chisel3/util/fetch/io/takeBranch.
	 -chisel3/util/fetch/io/takeBranch#
	 -chisel3/util/fetch/io/takeBranch().
	 -fetch/io/takeBranch.
	 -fetch/io/takeBranch#
	 -fetch/io/takeBranch().
	 -scala/Predef.fetch.io.takeBranch.
	 -scala/Predef.fetch.io.takeBranch#
	 -scala/Predef.fetch.io.takeBranch().
offset: 6804
...
class RiscVPipeline extends Module {
  ...
  io.fetchNextPC := {
    ...
    nextPcWire := Mux(fetch.io.takeBra@@nch, fetch.io.branchTarget, fetch.io.pc + 4.U)
    nextPcWire
  }
}
