error id: file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala:rs2Data
file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala
empty definition using pc, found symbol in pc: rs2Data
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/memory/io/rs2Data.
	 -chisel3/memory/io/rs2Data#
	 -chisel3/memory/io/rs2Data().
	 -chisel3/util/memory/io/rs2Data.
	 -chisel3/util/memory/io/rs2Data#
	 -chisel3/util/memory/io/rs2Data().
	 -memory/io/rs2Data.
	 -memory/io/rs2Data#
	 -memory/io/rs2Data().
	 -scala/Predef.memory.io.rs2Data.
	 -scala/Predef.memory.io.rs2Data#
	 -scala/Predef.memory.io.rs2Data().
offset: 6580
...
class RiscVPipeline extends Module {
  val io = IO(new Bundle {
    ...
    val fetchInst = Output(UInt(32.W)) // Debug: Current Instruction in Fetch Stage
  ...
  io.fetchInst  := fetch.io.instruction
  io.fetchStall := fetch.io.stall
  io.fetchPC    := fetch.io.pc
  io.fetchNextPC := {
    val nextPcWire = Wire(UInt(conf.xlen.W))
    nextPcWire := Mux(fetch.io.takeBranch, fetch.io.branchTarget, fetch.io.pc + 4.U)
    nextPcWire
  }
}
