error id: file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala:instruction
...
non-local guesses:
	 -chisel3/fetch/io/instruction.
	 -chisel3/fetch/io/instruction#
	 -chisel3/fetch/io/instruction().
	 -chisel3/util/fetch/io/instruction.
	 -chisel3/util/fetch/io/instruction#
	 -chisel3/util/fetch/io/instruction().
	 -fetch/io/instruction.
	 -fetch/io/instruction#
	 -fetch/io/instruction().
	 -scala/Predef.fetch.io.instruction.
	 -scala/Predef.fetch.io.instruction#
	 -scala/Predef.fetch.io.instruction().
offset: 6624
...
class RiscVPipeline extends Module {
  ...
  io.fetchInst  := fetch.io.instruc@@tion
