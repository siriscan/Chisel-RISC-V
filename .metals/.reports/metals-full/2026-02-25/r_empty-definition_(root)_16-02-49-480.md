error id: file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala:pcOut
file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala
empty definition using pc, found symbol in pc: pcOut
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/execute/io/pcOut.
	 -chisel3/execute/io/pcOut#
	 -chisel3/execute/io/pcOut().
	 -chisel3/util/execute/io/pcOut.
	 -chisel3/util/execute/io/pcOut#
	 -chisel3/util/execute/io/pcOut().
	 -core/execute/io/pcOut.
	 -core/execute/io/pcOut#
	 -core/execute/io/pcOut().
	 -execute/io/pcOut.
	 -execute/io/pcOut#
	 -execute/io/pcOut().
	 -scala/Predef.execute.io.pcOut.
	 -scala/Predef.execute.io.pcOut#
	 -scala/Predef.execute.io.pcOut().
offset: 7514
...
class RiscVPipeline extends Module {
  ...
  // Update BTB on JALR (and later on taken branches)
  btb.io.u_valid  := (execute.io.controlSignalsOut.jump === 2.U)
