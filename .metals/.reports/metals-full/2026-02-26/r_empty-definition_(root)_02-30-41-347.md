error id: file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/MemoryStage.scala:memAddress
file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/MemoryStage.scala
empty definition using pc, found symbol in pc: memAddress
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/atomic/io/memAddress.
	 -chisel3/atomic/io/memAddress#
	 -chisel3/atomic/io/memAddress().
	 -chisel3/util/atomic/io/memAddress.
	 -chisel3/util/atomic/io/memAddress#
	 -chisel3/util/atomic/io/memAddress().
	 -core/atomic/io/memAddress.
	 -core/atomic/io/memAddress#
	 -core/atomic/io/memAddress().
	 -atomic/io/memAddress.
	 -atomic/io/memAddress#
	 -atomic/io/memAddress().
	 -scala/Predef.atomic.io.memAddress.
	 -scala/Predef.atomic.io.memAddress#
	 -scala/Predef.atomic.io.memAddress().
offset: 3075
...
class MemoryStage(conf: CoreConfig) extends Module {
  ...
  dmem.io.addr     := Mux(useAtomic, atomic.io.memA@@ddress,   normAddr)
  dmem.io.memRead  := Mux(useAtomic, atomic.io.memRead,   normRead)
  dmem.io.memWrite := Mux(useAtomic, atomic.io.memWrite,  normWrite)
  dmem.io.mask     := Mux(useAtomic, atomic.io.memMask,   normMask)
  dmem.io.wrData   := Mux(useAtomic, atomic.io.memWrData, normWrData)
