error id: file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala:predTarget
file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala
empty definition using pc, found symbol in pc: predTarget
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/fetch/io/predTarget.
	 -chisel3/fetch/io/predTarget#
	 -chisel3/fetch/io/predTarget().
	 -chisel3/util/fetch/io/predTarget.
	 -chisel3/util/fetch/io/predTarget#
	 -chisel3/util/fetch/io/predTarget().
	 -core/fetch/io/predTarget.
	 -core/fetch/io/predTarget#
	 -core/fetch/io/predTarget().
	 -fetch/io/predTarget.
	 -fetch/io/predTarget#
	 -fetch/io/predTarget().
	 -scala/Predef.fetch.io.predTarget.
	 -scala/Predef.fetch.io.predTarget#
	 -scala/Predef.fetch.io.predTarget().
offset: 6035
...
//  val branchTargetDelayed = RegNext(RegNext(execute.io.branchTarget, 0.U), 0.U) // Delay branch target by 2 cycles  
  ...
  val branchMispredict = execute.io.branchTaken =/= id_ex.predTaken ||
    (execute.io.branchTaken && (execute.io.branchTarget =/= id_ex.predTarget))
  ...
  when(flush) { // On branch taken, flush the IF/ID register (Delay by 1 cycle)
    ...
    if_id.predTarget := fetch.io.predTa@@rget
  }
