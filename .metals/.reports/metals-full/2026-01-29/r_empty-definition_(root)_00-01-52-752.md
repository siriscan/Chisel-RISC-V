error id: file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala:predTaken
file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala
empty definition using pc, found symbol in pc: predTaken
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/fetch/io/predTaken.
	 -chisel3/fetch/io/predTaken#
	 -chisel3/fetch/io/predTaken().
	 -chisel3/util/fetch/io/predTaken.
	 -chisel3/util/fetch/io/predTaken#
	 -chisel3/util/fetch/io/predTaken().
	 -core/fetch/io/predTaken.
	 -core/fetch/io/predTaken#
	 -core/fetch/io/predTaken().
	 -fetch/io/predTaken.
	 -fetch/io/predTaken#
	 -fetch/io/predTaken().
	 -scala/Predef.fetch.io.predTaken.
	 -scala/Predef.fetch.io.predTaken#
	 -scala/Predef.fetch.io.predTaken().
offset: 5989
...
//  val branchTargetDelayed = RegNext(RegNext(execute.io.branchTarget, 0.U), 0.U) // Delay branch target by 2 cycles  
  ...
  when(flush) { // On branch taken, flush the IF/ID register (Delay by 1 cycle)
    ...
    if_id.predTaken := fetch.io.pred@@Taken
