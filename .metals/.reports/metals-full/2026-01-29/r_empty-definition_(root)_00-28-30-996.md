error id: file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala:controlSignalsOut
file:///C:/Users/irisc/Documents/CHISEL/Chisel-RISC-V/src/main/scala/integer/RiscVPipeline.scala
empty definition using pc, found symbol in pc: controlSignalsOut
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/execute/io/controlSignalsOut.
	 -chisel3/util/execute/io/controlSignalsOut.
	 -core/execute/io/controlSignalsOut.
	 -execute/io/controlSignalsOut.
	 -scala/Predef.execute.io.controlSignalsOut.
offset: 5371
...
//  val branchTargetDelayed = RegNext(RegNext(execute.io.branchTarget, 0.U), 0.U) // Delay branch target by 2 cycles  
  ...
  val jalrMispredict = jalrInst && (!id_ex.predTaken || (id_ex.predTarget =/= execute.io.branchTarget))

  val flush = execute.io.branchTaken || jalrMispredict // Flush on branch taken or JALR mispredict
  // Change branch taken later

  // Connections Between Stages
  // Fetch Stage Connections 
  fetch.io.takeBranch := flush
  
  fetch.io.branchTarget := execute.io.branchTarget
  fetch.io.btbUpdateValid  := (execute.io.control@@SignalsOut.jump === 2.U) // JALR 
                              // || (execute.io.controlSignalsOut.branch && execute.io.branchTaken) // Taken branches (Add later if desired)
  fetch.io.btbUpdatePC     := execute.io.pcOut // PC of branch/jump instruction
  fetch.io.btbUpdateTarget := execute.io.branchTarget // Use the target from Execute Stage
